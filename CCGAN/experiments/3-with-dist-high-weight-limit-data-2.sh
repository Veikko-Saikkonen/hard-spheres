...
#SBATCH --job-name=ccgan-training-3-with-dist-high-weight-limit-data-2
#SBATCH --account=project_2010169
#SBATCH --output=3-with-dist-high-weight-limit-data-2.out
#SBATCH --error=3-with-dist-high-weight-limit-data-2.err
...
EXPERIMENT_NAME="3-with-dist-high-weight-limit-data-2"
