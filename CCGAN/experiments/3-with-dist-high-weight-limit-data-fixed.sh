...
#SBATCH --job-name=ccgan-training-3-with-dist-high-weight-limit-data-fixed
#SBATCH --account=project_2010169
#SBATCH --output=3-with-dist-high-weight-limit-data-fixed.out
#SBATCH --error=3-with-dist-high-weight-limit-data-fixed.err
...
EXPERIMENT_NAME="3-with-dist-high-weight-limit-data-fixed"
