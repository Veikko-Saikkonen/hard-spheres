...
#SBATCH --job-name=ccgan-training-3-with-dist-high-weight-limit-data
#SBATCH --account=project_2010169
#SBATCH --output=3-with-dist-high-weight-limit-data.out
#SBATCH --error=3-with-dist-high-weight-limit-data.err
...
EXPERIMENT_NAME="3-with-dist-high-weight-limit-data"
