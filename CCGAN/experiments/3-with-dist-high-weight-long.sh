...
#SBATCH --job-name=ccgan-training-3-with-dist-high-weight-long
#SBATCH --account=project_2010169
#SBATCH --output=3-with-dist-high-weight-long.out
#SBATCH --error=3-with-dist-high-weight-long.err
...
EXPERIMENT_NAME="3-with-dist-high-weight-long"
